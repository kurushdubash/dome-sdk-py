...
class TestAsyncMarketEndpoints:
    """Test cases for AsyncMarketEndpoints."""

    @pytest.fixture
    def client(self):
        """Create a test async client."""
        return AsyncDomeClient({"api_key": "test-api-key"})
    ...
    @pytest.mark.asyncio
    async def test_get_market_price_with_at_time(self, client):
        """Test market price fetch with at_time parameter."""
        mock_response = {
            "price": 0.220,
            "at_time": 1757008834,
...
class TestAsyncWalletEndpoints:
    """Test cases for AsyncWalletEndpoints."""
...
class TestAsyncOrdersEndpoints:
    """Test cases for AsyncOrdersEndpoints."""
...
class TestAsyncMatchingMarketsEndpoints:
    """Test cases for AsyncMatchingMarketsEndpoints."""
